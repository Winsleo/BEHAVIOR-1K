...
class RAPPERWrapper(EnvironmentWrapper):
    ...
    def _update_dynamic_map(self, static_map: th.Tensor, robot: Robot) -> th.Tensor:
        """
    ...
    def _erode_map_custom(self, trav_map: th.Tensor, robot: Robot) -> th.Tensor:
        """
